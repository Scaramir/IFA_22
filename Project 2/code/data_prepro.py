...
def create_folds_from_ds(dst_path='.', folds=(1,2,3,4,5)):
    ...
    for nfold in folds:
        ...
        for row in db.readlines():
            ...
            # get only the images with a magnification of 200x
            if mag != '200':
                continue
            # TODO: combine all folds into a single directory, and split in train and test sets regarding the M or B label in the filename.
